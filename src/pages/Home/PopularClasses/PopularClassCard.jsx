...
const PopularClassCard = ({ popularClass, enrolledClasses, refetch }) => {
    ...
    return (
        <>
            {
                isInstructorLoading || isAdminLoading ? '' : <div
                    data-aos="flip-left"
                    ...
                    <div className={`relative block ${seats <= 0 ? 'bg-red-300 opacity-60' : 'bg-slate-300'}  rounded-lg shadow-lg h-[465px] w-72`}>
                        ...
                        <div className="px-6 py-3">
                            ...
                            <div className="mt-3 flex justify-between items-center">
                                ...
                                <button onClick={() => handleEnroll(popularClass._id)} className="uppercase px-4 py-2 rounded-md hover:bg-[#981b1bd9] bg-[#E80040] text-white font-bold disabled:opacity-50" disabled={isAdmin || isInstructor || isDisabled || seats <= 0} >Enroll Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div className="relative block bg-red-300 rounded-lg shadow-lg h-[465px] w-72 opacity-60">
                                    ...
                                    <div className="px-6 py-3">
                                        ...
                                        <div className="mt-3 flex justify-between items-center">
                                            <p className="bg-[#E80040] bg-opacity-70 text-white px-4 py-2 rounded-lg">$ {price}</p>
                                            <button disabled className="uppercase px-4 py-2 rounded-md bg-[#E80040] border-[#E80040] text-white font-bold">Enroll Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
